...
class lector:
  ...
  # receive a value of range between 0 and 0.1.
	...
	#print cord_z_0, cord_y_2, cord_y_4, cord_y_7
    	...
    	if self.senal == 1 and cord_z_0 > 0.82 and cord_y_2 >= 1.18 and cord_y_2 <= 1.21 and cord_y_4 >= 1.48 and cord_y_4 <= 1.51 and cord_y_7 >= 1.78 and cord_y_7 <= 1.85:
	    cont_0 = cord_y_2
	    cont_1 = cord_y_4
	    cont_2 = cord_y_7
	    for c in range(30):
   	    	self.Mover_obj('block_red', cont_0)
   	    	self.Mover_obj('block_red_2', cont_1)
   	    	self.Mover_obj('block_blue_1', cont_2)
	    	cont_0 = cont_0 - 0.01
	    	cont_1 = cont_1 - 0.01
	    	cont_2 = cont_2 - 0.01
   	    self.Mover_obj('block_red', 0.895)
	    inter1 = 1
	    inter2 = 0
	    cont = 0

        elif self.senal == 1 and cord_z_2 > 0.82 and cord_y_4 >= 1.18 and cord_y_4 <= 1.22 and cord_y_7 >= 1.48 and cord_y_7 <= 1.52:
	    cont_0 = cord_y_2
	    cont_1 = cord_y_4
	    cont_2 = cord_y_7
	    for c in range(30):
