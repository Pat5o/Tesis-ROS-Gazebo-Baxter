...
class pose_1(State):
    def __init__(self):
        ...
        self.letter_y = {
            'letter': {
                      'left':  [0.72, -0.71, 0.08, 1.27,  3.04, -1.02, 2.11],
...
class pose_11(State):
    def __init__(self):
        ...
        self.zero = {
            'letter': {
                      'left':  [0.21, -0.77, 0.27, 1.21,  2.89, -1.17, 1.30],
                      'right':  [-1.65, -0.74,  0.45, 1.40, -0.32, 1.018,  2.75]
                       } } 
                         #DoF Key [s0,s1,e0,e1,w0,w1,w2]
...
class pose_12(State):
    def __init__(self):
        ...
        self.zero = {
            'letter': {
                      'left':  [0.21, -0.77, 0.27, 1.21,  2.89, -1.17, 1.30],
                      'right':  [-1.26, -0.88,  0.45, 1.76, -0.36, 0.81,  0.25]
                       } } 
                         #DoF Key [s0,s1,e0,e1,w0,w1,w2]
...
class pose_13(State):
    def __init__(self):
        ...
        self.zero = {
            'letter': {
                      'left':  [0.21, -0.77, 0.27, 1.21,  2.89, -1.17, 1.30],
                      'right':  [-0.75, -0.88,  0.45, 1.76, -0.37, 0.81,  0.61]
                       } } 
                         #DoF Key [s0,s1,e0,e1,w0,w1,w2]
...
def clasificacion_1(objeto_form,objeto_color):
    if objeto_form == 'Cubo Rectangular':
