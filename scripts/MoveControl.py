...
class Baxter_Arms():
    ...
    def open_gripper(self, limb):
        self.gripper = baxter_interface.Gripper(limb)
        self.gripper.open('electric')

    def close_gripper(self, limb):
        self.gripper = baxter_interface.Gripper(limb)
        self.gripper.close('electric')

    def move_to_pose(self, pose, limb):
        self.limb = baxter_interface.Limb(limb)
        self.limb.move_to_joint_positions(pose)
